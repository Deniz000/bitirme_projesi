package com.freeSite.business.dtos.requests.filters;
...
@AllArgsConstructor
@NoArgsConstructor
public class CandidateWithDetailsResponse {
	private int id;
		...
		private LocalDate schoolStartDay;
		
		private LocalDate schoolEndDay;
